...
from src.keep_agent_running.models.handlers import Task, LLMTaskHandler
...
if __name__ == "__main__":
    ...
    t = run_project(
        ...
        orchestration_task_handler=LLMTaskHandler(
        ...
        task_assignment_handler=LLMTaskHandler(
            llm_config=llm_config,
        ...
        streamer=Streamer(),
        pydantic_converter=PydanticConverter(llm_config=llm_config),
    )
