...
def make_output_into_pydantic_models(
    output: str, pydantic_model: Type[BaseModel], llm_config: LLMConfig
) -> BaseModel:
    """
    ...
    llm = OpenAI(base_url=llm_config.base_url, api_key=llm_config.api_key)
...
def make_output_into_pydantic_model_list(
    output: str, pydantic_model: Type[BaseModel], llm_config: LLMConfig
) -> List[BaseModel]:
    """
